            ...
            <div className="flex flex-col gap-4">
                <div className="grid gap-4 md:grid-cols-3">
                        ...
                        <CardContent>
                            ...
                            <div className="mt-4">
                                <Alert>
                                    ...
                                    <AlertDescription>
                                        Next installment due on Aug 30, 2024.
                                        Please settle before the deadline.
                                    </AlertDescription>
                                </Alert>
                            </div>
                        </CardContent>
                    ...
                    <Card className="md:col-span-2">
                        <CardHeader>
                            ...
                            <CardDescription>
                                Breakdown of your current balance.
                            </CardDescription>
                        </CardHeader>
                        <CardContent>
                            <Table>
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>
                            History of your recent transactions.
                        </CardDescription>
                    </CardHeader>
                    <CardContent>
                        <Table>
