        ...
        switch (status.toLowerCase()) {
            case 'enrolled':
                return (
                    <Badge
                        variant="outline"
                        className="border-emerald-500 bg-emerald-50 text-[10px] font-bold text-emerald-700 uppercase hover:bg-emerald-100"
                    >
                        Active
                    </Badge>
                );
            case 'transferred':
                return (
                    <Badge
                        variant="outline"
                        className="border-blue-500 bg-blue-50 text-[10px] font-bold text-blue-700 uppercase hover:bg-blue-100"
                    >
                        Transferred
                    </Badge>
                );
            case 'dropped':
                return (
                    <Badge
                        variant="outline"
                        className="border-rose-500 bg-rose-50 text-[10px] font-bold text-rose-700 uppercase hover:bg-rose-100"
                    >
                        Dropped
                    </Badge>
                );
                                ...
                                >
                                    <Table>
                                        <TableHeader className="bg-muted/30">
                                            <TableRow>
                                                <TableHead className="w-[150px] pl-6 text-[10px] font-black uppercase">
                                                    LRN
                                                </TableHead>
                                                <TableHead className="text-center text-[10px] font-black uppercase">
                                                    Student Name
                                                </TableHead>
                                                <TableHead className="w-[100px] text-center text-[10px] font-black uppercase">
                                                    Gender
                                                </TableHead>
                                                <TableHead className="w-[150px] pr-6 text-right text-[10px] font-black uppercase">
                                                    Status
                                                </TableHead>
                                            </TableRow>
                                        </TableHeader>
                                                ...
                                                (enrollment) => (
                                                    ...
                                                    >
                                                        ...
                                                        <TableCell className="text-center">
                                                            <Badge
                                                                variant="secondary"
                                                                className="text-[10px] font-normal tracking-tighter uppercase"
                                                            >
                                                                {
                                                                    enrollment
                                                                        .student
