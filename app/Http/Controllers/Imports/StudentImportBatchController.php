...
use App\Services\Imports\StudentImportApplyService;
use App\Services\Imports\StudentImportPreviewService;
...
class StudentImportBatchController extends Controller
{
    ...
    public function __construct(
        private StudentImportPreviewService $previewService,
        private StudentImportApplyService $applyService,
    ) {}
